...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/database.Config"
                        }
                    }
                ],
                "responses": {
        ...
        "/route-segments": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Route segment file (GPX)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    },
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "1 year",
                        "description": "Start of time range (e.g. '1 year')",
                        "name": "since",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "default": "month",
                        "description": "Bucket size (e.g. 'month', 'week', 'day')",
                        "name": "per",
                        "in": "query"
                    }
                ],
        ...
        "/workouts": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Workout file (GPX, TCX, FIT)",
                        "name": "file",
                        "in": "formData"
                    },
                    {
        ...
        "/workouts/calendar": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Start date-time (2006-01-02T15:04:05)",
                        "name": "start",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "End date-time (2006-01-02T15:04:05)",
                        "name": "end",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "default": 20,
                        "description": "Maximum number of workouts to return (max 100)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
        ...
        "/workouts/{id}/route-segment": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Route segment parameters",
                        "name": "params",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/database.RoutSegmentCreationParams"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "database.Config": {
            ...
            "properties": {
                "bind": {
                    "description": "Which address to bind to",
                    "type": "string"
                },
                "createdAt": {
                    "type": "string"
                ...
                "debug": {
                    "description": "Debug logging mode",
                    "type": "boolean"
                },
                "dev": {
                ...
                "dsnfile": {
                    "description": "File containing the database DSN",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
                ...
                "jwtencryptionKey": {
                    "description": "Encryption key for JWT",
                    "type": "string"
                },
                "jwtencryptionKeyFile": {
                    "description": "File containing the encryption key for JWT",
                    "type": "string"
                },
                "logging": {
                ...
                "offline": {
                    "description": "Disable calls to external services",
                    "type": "boolean"
                },
                "registration_disabled": {
                    "type": "boolean"
                ...
                "webRoot": {
                    "description": "The web root path (relative to the bind address)",
                    "type": "string"
                },
                "workerDelaySeconds": {
                    "description": "Time in seconds between worker runs",
                    "type": "integer"
                }
            }
        },
        ...
        "database.RoutSegmentCreationParams": {
            "type": "object",
            "properties": {
                "end": {
                    "type": "integer"
